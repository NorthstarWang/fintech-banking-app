...
class VendorRiskRepository:
    ...
    async def find_vendor_by_id(self, vendor_id: UUID) -> Vendor | None:
        return self._vendors.get(vendor_id)

    async def find_vendor_by_code(self, vendor_code: str) -> Vendor | None:
    ...
    async def find_due_diligence_by_id(self, dd_id: UUID) -> VendorDueDiligence | None:
    ...
    async def find_incident_by_id(self, incident_id: UUID) -> VendorIncident | None:
