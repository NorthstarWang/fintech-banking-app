...
class IncidentRepository:
    ...
    async def find_incident_by_id(self, incident_id: UUID) -> Incident | None:
        return self._incidents.get(incident_id)

    async def find_incident_by_number(self, incident_number: str) -> Incident | None:
    ...
    async def find_rca_by_incident(self, incident_id: UUID) -> IncidentRootCauseAnalysis | None:
    ...
    async def find_corrective_action_by_id(self, action_id: UUID) -> IncidentCorrectiveAction | None:
