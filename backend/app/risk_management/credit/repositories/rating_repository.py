...
class RatingRepository:
    ...
    async def find_by_id(self, rating_id: UUID) -> CreditRating | None:
        return self._ratings.get(rating_id)

    async def find_by_entity(self, entity_id: str) -> CreditRating | None:
    ...
    async def find_scale_by_agency(self, agency: RatingAgency) -> RatingScale | None:
    ...
    async def find_model_by_id(self, model_id: UUID) -> RatingModel | None:
