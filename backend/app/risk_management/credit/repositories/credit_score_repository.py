...
from ..models.credit_score_models import CreditScore, CreditScoreRequest, ScoreCategory
...
class CreditScoreRepository:
    ...
    async def find_by_id(self, score_id: UUID) -> CreditScore | None:
    ...
    async def find_latest_by_customer(self, customer_id: str) -> CreditScore | None:
    ...
    async def find_request_by_id(self, request_id: UUID) -> CreditScoreRequest | None:
