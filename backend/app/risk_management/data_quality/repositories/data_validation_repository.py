...
class DataValidationRepository:
    ...
    async def find_rule_by_id(self, rule_id: UUID) -> ValidationRule | None:
    ...
    async def find_execution_by_id(self, execution_id: UUID) -> ValidationExecution | None:
    ...
    async def find_result_by_id(self, result_id: UUID) -> ValidationResult | None:
    ...
    async def find_error_by_id(self, error_id: UUID) -> ValidationError | None:
    ...
    async def find_schedule_by_id(self, schedule_id: UUID) -> ValidationSchedule | None:
    ...
    async def find_report_by_id(self, report_id: UUID) -> ValidationReport | None:
    ...
    async def find_realtime_validation_by_id(self, validation_id: UUID) -> RealTimeValidation | None:
