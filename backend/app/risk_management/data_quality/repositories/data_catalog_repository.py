...
class DataCatalogRepository:
    ...
    async def find_entry_by_id(self, entry_id: UUID) -> CatalogEntry | None:
    ...
    async def find_schema_by_id(self, schema_id: UUID) -> SchemaDefinition | None:
        return self._schemas.get(schema_id)

    async def find_all_schemas(self) -> list[SchemaDefinition]:
        return list(self._schemas.values())

    async def find_schema_by_entry(self, entry_id: UUID) -> SchemaDefinition | None:
    ...
    async def find_usage_by_id(self, usage_id: UUID) -> DatasetUsage | None:
    ...
    async def find_rating_by_id(self, rating_id: UUID) -> DatasetRating | None:
    ...
    async def find_comment_by_id(self, comment_id: UUID) -> DatasetComment | None:
    ...
    async def find_bookmark_by_id(self, bookmark_id: UUID) -> DatasetBookmark | None:
    ...
    async def find_bookmark_by_user_and_entry(self, user_id: str, entry_id: UUID) -> DatasetBookmark | None:
    ...
    async def find_search_by_id(self, search_id: UUID) -> SearchHistory | None:
    ...
    async def find_collection_by_id(self, collection_id: UUID) -> CatalogCollection | None:
    ...
    async def find_dictionary_entry_by_id(self, dictionary_id: UUID) -> DataDictionary | None:
