...
class GDPRRepository:
    ...
    async def find_activity_by_id(self, activity_id: UUID) -> ProcessingActivity | None:
    ...
    async def find_consent_by_id(self, consent_id: UUID) -> DataSubjectConsent | None:
    ...
    async def find_dsar_by_id(self, dsar_id: UUID) -> DataSubjectAccessRequest | None:
    ...
    async def find_breach_by_id(self, breach_id: UUID) -> DataBreach | None:
    ...
    async def find_dpia_by_id(self, dpia_id: UUID) -> DataProtectionImpactAssessment | None:
    ...
    async def find_retention_policy_by_id(self, policy_id: UUID) -> DataRetentionPolicy | None:
    ...
    async def find_transfer_by_id(self, transfer_id: UUID) -> CrossBorderTransfer | None:
    ...
    async def find_report_by_id(self, report_id: UUID) -> GDPRReport | None:
