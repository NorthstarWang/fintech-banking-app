...
from ..models.case_models import AMLCase, CaseCategory, CasePriority, CaseStatus
...
class CaseRepository:
    ...
    async def get_by_id(self, case_id: UUID) -> AMLCase | None:
        """Get case by ID"""
        return self._cases.get(case_id)

    async def get_by_number(self, case_number: str) -> AMLCase | None:
