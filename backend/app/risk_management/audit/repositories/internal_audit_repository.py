...
class InternalAuditRepository:
    ...
    async def find_audit_by_id(self, audit_id: UUID) -> InternalAudit | None:
    ...
    async def find_workpaper_by_id(self, workpaper_id: UUID) -> AuditWorkpaper | None:
    ...
    async def find_finding_by_id(self, finding_id: UUID) -> AuditFinding | None:
    ...
    async def find_report_by_id(self, report_id: UUID) -> AuditReport | None:
    ...
    async def find_follow_up_by_id(self, follow_up_id: UUID) -> AuditFollowUp | None:
