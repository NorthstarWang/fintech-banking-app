...
from ..models.fx_risk_models import FXExposure, FXPosition, FXRate, FXScenario, FXVolatilitySurface
...
class FXRiskRepository:
    ...
    async def find_position_by_id(self, pos_id: UUID) -> FXPosition | None:
    ...
    async def find_rate_by_pair(self, currency_pair: str) -> FXRate | None:
