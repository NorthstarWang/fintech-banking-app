...
class AssetConverter:
    ...
    def _determine_conversion_type(
        ...
        elif from_class == AssetClass.CRYPTO and to_class == AssetClass.FIAT:
            return ConversionType.CRYPTO_TO_FIAT
        elif from_class == AssetClass.CRYPTO and to_class == AssetClass.CRYPTO:
            return ConversionType.CRYPTO_TO_CRYPTO
        elif from_class == AssetClass.CREDIT:
