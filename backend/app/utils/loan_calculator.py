...
class LoanCalculator:
    ...
    def generate_amortization_schedule(
        ...
        for payment_num in range(1, term_months + 1):
            ...
            extra = 0
            if extra_payment > 0:
                if extra_payment_frequency == "monthly" or (extra_payment_frequency == "quarterly" and payment_num % 3 == 0) or (extra_payment_frequency == "annually" and payment_num % 12 == 0):
                    extra = extra_payment
    ...
    def calculate_debt_to_income(
        ...
        new_loan_payment: float | None = None
    ) -> dict[str, float]:
        """
