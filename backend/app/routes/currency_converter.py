...
from app.models.entities.currency_converter_models import (
    CurrencyType, TransferMethod, TransferStatus,
    ExchangeRateResponse, ConversionQuoteRequest, ConversionQuoteResponse,
    ConversionOrderCreate, ConversionOrderResponse,
    PeerOfferCreate, PeerOfferResponse,
    P2PTradeRequest, P2PTradeResponse,
    CurrencyBalanceResponse, ConversionHistoryResponse,
...
async def get_supported_currencies(
    currency_type: Optional[CurrencyType] = Query(None, description="Filter by currency type"),
...
async def search_peer_offers(
    ...
    transfer_method: Optional[TransferMethod] = Query(None, description="Preferred transfer method"),
    current_user = Depends(get_current_user)
