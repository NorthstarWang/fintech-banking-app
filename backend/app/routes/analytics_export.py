...
from ..models import (
    ...
    TransactionType, AccountType, BudgetPeriod, GoalStatus
)
...
async def export_net_worth_csv(
    ...
    return Response(
        ...
        media_type='text/csv',
        headers={
            'Content-Disposition': f'attachment; filename=net_worth_history.csv'
        }
    )
...
async def export_net_worth_pdf(
    ...
    return Response(
        ...
        media_type='application/pdf',
        headers={
            'Content-Disposition': f'attachment; filename=net_worth_history.pdf'
        }
    )